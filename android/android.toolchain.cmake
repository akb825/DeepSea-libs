...
# Android NDK
# NOTE: Specifying by command line seems to break horribly, so need to use environment
# variable already used in other scripts.
get_filename_component(ANDROID_NDK_EXPECTED_PATH
    "$ENV{ANDROID_NDK}" ABSOLUTE)
if(NOT ANDROID_NDK)
...
# NOTE: This makes it impossible to set CMAKE_FIND_ROOT_PATH on the command line.
# We need to duplicate the toolchain for now in order to build libraries with
# dependencies on other pre-built libraries.
